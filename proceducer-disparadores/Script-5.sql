...
CALL sp_asignar_servicio(3, 'Nicol Gonzalez', 'nicolG1206@gmail.com', '151512632063256', @res);
SELECT @res;

CALL sp_obetner_suscripciones();


SHOW PROCEDURE STATUS WHERE db = 'curso_sql';
DROP PROCEDURE sp_obetner_suscripciones;
